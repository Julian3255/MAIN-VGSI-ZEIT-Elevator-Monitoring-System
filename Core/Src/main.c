...
/* Variables for testing EMS SPI communication */
int spi2_count = 0;

/* Variables for CAN transmission*/
volatile uint16 rx_done = 0;
volatile uint16 tx_done = 0;
uint8 txBuffer1[2] = {0x55, 0xAA};
uint8 txBuffer2[2] = {0x00, 0x03};
uint8 data_count = 0;
uint8 rxLength;
uint8 TxDataAdrr[8] =
{
...
//uint8 ID_48C[8];
uint8 ID_68B[8];
//uint8 EMS2_Data[8] = {0x12, 0x33, 0x55, 0xAA, 0x78, 0x52, 0x39, 0x02};
...
//    }
  ...
  /* Testing EMS SPI communicationo */
...
//  #if(TEST_FUNCTION == EMS_COM)
//
//	  MCP2515_ReadReg(MCP_CANINTF, &can_intf, 1);
//	  MCP2515_ReadReg(MCP_RXB0CTRL, &rxb0ctrl, 1);
//	  MCP2515_ReadReg(MCP_RXB1CTRL, &rxb1ctrl, 1);
//	  MCP2515_ReadReg(MCP_CANINTE, &can_inte, 1);
//
//    MCP2515_ReadReg(0x2A, &cnf1, 1);
//    MCP2515_ReadReg(0x29, &cnf2, 1);
//    MCP2515_ReadReg(0x28, &cnf3, 1);
//
//	  MCP2515_ReadReg(MCP_CANSTAT, &can_ctrl, 1);
//	  MCP2515_ReadReg(MCP_CANSTAT, &canstat, 1);
//	  MCP2515_ReadReg(MCP_EFLG, &eflg, 1);
//	  MCP2515_GetRxStatus(&rx_status);
//	  MCP2515_ReadStatus(&status);
//	  MCP2515_ReadReg(0x1D, &rec, 1);
//
//	  if (can_intf & (0x01)) {
//		  rx_done++;
//
...
//	            MCP2515_ReadReg(0x66, &EMS2_Data[0], 1);
//	            MCP2515_ReadReg(0x67, &EMS2_Data[1], 1);
//	            MCP2515_ReadReg(0x68, &EMS2_Data[2], 1);
//	            MCP2515_ReadReg(0x69, &EMS2_Data[3], 1);
//	            MCP2515_ReadReg(0x6A, &EMS2_Data[4], 1);
//	            MCP2515_ReadReg(0x6B, &EMS2_Data[5], 1);
//	            MCP2515_ReadReg(0x6C, &EMS2_Data[6], 1);
//	            MCP2515_ReadReg(0x6D, &EMS2_Data[7], 1);
//
...
//    MCP2515_WriteReg(MCP_TXB0SIDH, 0x31, 1);
//    MCP2515_WriteReg(MCP_TXB0SIDL, 0x80, 1);
//    MCP2515_WriteReg(MCP_TXB0DLC, 0x08, 1);
//
//    MCP2515_WriteReg(MCP_TXB0_DATA0, EMS2_Data[0], 1);
//    MCP2515_WriteReg(MCP_TXB0_DATA1, EMS2_Data[1], 1);
//    MCP2515_WriteReg(MCP_TXB0_DATA2, EMS2_Data[2], 1);
//    MCP2515_WriteReg(MCP_TXB0_DATA3, EMS2_Data[3], 1);
//    MCP2515_WriteReg(MCP_TXB0_DATA4, EMS2_Data[4], 1);
//    MCP2515_WriteReg(MCP_TXB0_DATA5, EMS2_Data[5], 1);
//    MCP2515_WriteReg(MCP_TXB0_DATA6, EMS2_Data[6], 1);
//    MCP2515_WriteReg(MCP_TXB0_DATA6, EMS2_Data[7], 1);
//	  }
//
//    MCP2515_ReadStatus(&status);
//
//    /* Read the tranmission request bit, addresses and byte length */
//    MCP2515_ReadReg(MCP_TXB0CTRL, &tx0_ctrl, 1);
//    MCP2515_ReadReg(MCP_TXB0SIDH, &tx0_sidh, 1);
//    MCP2515_ReadReg(MCP_TXB0SIDL, &tx0_sidl, 1);
//    MCP2515_ReadReg(MCP_TXB0DLC, &tx0_dlc, 1);
//
//    /* Read register for bit timing to ensure correct transmission speed - 125kbps */
//    MCP2515_ReadReg(0x2A, &cnf1, 1);
//    MCP2515_ReadReg(0x29, &cnf2, 1);
//    MCP2515_ReadReg(0x28, &cnf3, 1);
//    MCP2515_ReadReg(0x1C, &tec, 1);
//
//    // Read the data bytes in the frame
//    Read_TXdata(8);
//
